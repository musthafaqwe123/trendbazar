...
KEY_ID="rzp_test_4IMrQjUs8d4UyO"
KEY_SECRET="8T0dCDNn529EtpaVK8foTCKM"
...
class CartItemListView(View):
    def get(self,request,*args,**kwargs):
        qs=request.user.cart.cartitems.filter(is_order_place=False)
        return render(request,'cart_items.html',{'data':qs})

#url :localhost:8000/baskets/basketitem/{id}/remove/
