...
urlpatterns=[
    ...
    path('product/<int:pk>/',views.ProductDtailView.as_view(),name='product-detail'),
    ...
    path('basket/items/<int:pk>/remove/',views.BasketItemDeleteView.as_view(),name='item-delete'),
